...
export function saveCustomer(customer) {
    ...
    http.open("POST","http://localhost:8080/JavaEE_POS_Backend/customer")
...
export function getAllCustomers() {
    ...
    return new Promise((resolve, reject) => {
        $.ajax({
            url: `http://localhost:8080/JavaEE_POS_Backend/customer?id=all`,
            method: "GET",
...
export function deleteCustomer(index){
    ...
    $.ajax({
        url : `http://localhost:8080/JavaEE_POS_Backend/customer?id=${index}`,
        method : "DELETE",
        success : function (res){
